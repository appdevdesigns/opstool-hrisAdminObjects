...
function(){
    ...
    AD.controllers.opstools.BalanceReportTool.BalanceReportSendNational = can.Control.extend({


        init: function( element, options ) {
            var self = this;
            this.options = AD.defaults({
                    templateDOM: '//opstools/BalanceReportTool/views/BalanceReportSendNational/BalanceReportSendNational.ejs',
            }, options);
